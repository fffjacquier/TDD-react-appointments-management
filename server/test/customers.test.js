...
describe('customers', () => {
  ...
  describe('add', () => {
    it.skip('returns the same fields as provided', () => {
    ...
    it.skip('generates different ids to each customer', () => {
  ...
  describe('all', () => {
    ...
    it.skip('returns all added customers', () => {
      const customers = new Customers()
  ...
  describe('errors', () => {
    ...
    it.skip('returns no errors for an object with all correct params', () => {
      expect(customers.errors(customer)).toEqual({})
    })

    it.skip('returns error if the phone number is already used', () => {
    ...
    it.skip('returns error if the first name is blank', () => {
    ...
    it.skip('returns error if the last name is blank', () => {
    ...
    it.skip('returns error if the phone number is blank', () => {
    ...
    it.skip('returns one error for each required field when missing', () => {
      expect(Object.keys(customers.errors({}))).toEqual([
        'firstName',
        'lastName',
        'phoneNumber',
      ])
  ...
  describe('isValid', () => {
    ...
    it.skip('returns true for a valid object', () => {
      expect(new Customers().isValid(customer)).toBeTruthy()
    })

    it.skip('returns false for an invalid object', () => {
      const newCustomer = { ...customer, firstName: '' }
  ...
  describe('search customers', () => {
    ...
    it.skip('returns only customers matching last name search terms', () => {
      const customers = new Customers([
    ...
    it.skip('returns only customers matching phone number search terms', () => {
      const customers = new Customers([
        { phoneNumber: '123' },
        { phoneNumber: '234' },
      ])
    ...
    it.skip('only matches on start of text string', () => {
      const customers = new Customers([
        { phoneNumber: '123' },
        { phoneNumber: '234' },
      ])
    ...
    it.skip('does not list search result twice if it matches more than one field', () => {
      const customers = new Customers([{ firstName: 'A', lastName: 'A' }])
      const result = customers.search({
        searchTerms: ['A'],
        orderBy: 'firstName',
      })
    ...
    it.skip('sorts according to the order by field', () => {
      const customers = new Customers([
    ...
    it.skip('limits records by limit', () => {
      const customers = new Customers([
    ...
    it.skip('pages to the first record after the one specified', () => {
      const customers = new Customers([
        { firstName: 'A', phoneNumber: '1' },
        { firstName: 'A', phoneNumber: '2' },
        { firstName: 'A', phoneNumber: '3' },
    ...
    it.skip('returns everything if no search terms defined', () => {
      const customers = new Customers([{ firstName: 'A' }, { firstName: 'B' }])
      const result = customers.search({})
      expect(result.length).toEqual(2)
    })

    it.skip('by default limits to ten records', () => {
      const customers = new Customers()
      for (let i = 0; i < 20; ++i) {
    ...
    it.skip('by default order by firstName', () => {
      const customers = new Customers([
